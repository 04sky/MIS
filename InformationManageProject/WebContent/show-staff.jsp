...
<body>
		...
		<% 
        	List<FullStaffs> staffs = (List<FullStaffs>)request.getAttribute("staffs"); 
    	%>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">员工展示</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tbody>
                                            	<c:forEach items="${staffs}" var="staff">
                                            		<tr> 
										                ...
										                <td>${staff.birth}</td> 
										                <td>${staff.home}</td> 
										                <td>${staff.departmentString }</td> 
										                <td>${staff.titleString}</td>
										                <c:if test="${staff.status eq '1' }">
										                	<td><span class="badge badge-success">在职</span></td>
										                	<td>
										                	<a href="${pageContext.request.contextPath}/download.staff?operation=download&id=${staff.id}">离职</a>/
										                	<a href="${pageContext.request.contextPath}/update.staff?operation=showOne&id=${staff.id}">修改</a>/
										                	<a href=" ${pageContext.request.contextPath}/delete.staff?operation=delete&id=${staff.id}">删除</a>
										                	</td>
										                </c:if>
										                <c:if test="${staff.status eq '2' }">
										                	<td><span class="badge badge-danger">离职</span></td>
										                	<td>
										                	<a href="${pageContext.request.contextPath}/upload.staff?operation=upload&id=${staff.id}">在职</a>/
										                	<a href="${pageContext.request.contextPath}/showOne.staff?operation=showOne&id=${staff.id}">修改</a>/
										                	<a href="${pageContext.request.contextPath}/delete.staff?operation=delete&id=${staff.id}">删除</a>
										                	</td>
										                </c:if>
										            </tr>
